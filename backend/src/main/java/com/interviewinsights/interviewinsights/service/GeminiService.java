                   ...
                   3. Ignore:
                      ...
                      - conversational follow-up questions like:
                        ...
                        unless they introduce a completely new interview question.
                         ...
                         4. For aptitude, extract the aptitude topic when the student mentions a topic instead of an exact question.
                        Examples:
                        - "Topics included percentages and time and work."
                        Return: "Percentages", "Time and Work"
                        - "The aptitude round covered logical reasoning and data interpretation."
                        Return: "Logical Reasoning", "Data Interpretation"
                   
                  5. If the student describes a coding problem instead of writing the exact question,
   rewrite it as a clear coding interview question.
...
6. For aptitude, return only the topic name.
   Do NOT rewrite aptitude topics as questions or sentences.

   Examples:

   Student writes:
   "The aptitude round covered percentages and time and work."
   ...
   Student writes:
   "There were questions on seating arrangements and syllogisms."
   ...
   Student writes:
   "The verbal section included reading comprehension and sentence correction."
   ...
   "Sentence Correction"
                   ...
                   9. If a category has no questions, return an empty array.
                   
                   10. Return ONLY valid JSON.
                   11. If the same question appears multiple times in the experience,
                    return it only once.
